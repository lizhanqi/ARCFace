...
import static com.arcsoft.face.toolkit.ImageFactory.getRGBData;
    ...
    public   class FaceEngineTest {
        ...
        public static void main(String[] args) {
            ...
            //人脸检测
            ImageInfo imageInfo = getRGBData(new File("0.jpg"));
            ...
            System.out.println(+genderCode+"性别：" + genderInfoList.get(1).getGender());
            //年龄检测
            List<AgeInfo> ageInfoList = new ArrayList<AgeInfo>();
            int ageCode = faceEngine.getAge(ageInfoList);
         //   assertEquals("年龄检测失败", ageCode, ErrorInfo.MOK.getValue());
            System.out.println("年龄：" + ageInfoList.get(1).getAge());
            ...
            //IR属性处理
            ImageInfo imageInfoGray = getGrayData(new File("0.jpg"));
            ...
            System.out.println("特征：" + faceFeature.getFeatureData().toString());
